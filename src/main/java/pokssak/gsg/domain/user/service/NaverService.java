...
import pokssak.gsg.common.config.KakaoConfig;
import pokssak.gsg.common.config.NaverConfig;
...
public class NaverService implements OAuthService {
    ...
    public User getOAuthUser(String oauthPlatformId) {
        return userRepository.findByOauthPlatformIdAndJoinType(oauthPlatformId, JoinType.KAKAO)
